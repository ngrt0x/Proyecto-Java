...
public class JuegoControlador {
	...
	public void crearJugador() {
		...
		// crear el tripulante, y borrar su nombre y el rol asignado de los arrays
		// correspondientes
		// ARREGLAR ARREGLAR, HAY QUE CREAR LOS TRIPULANTES EN BASE A LAS SELECCIONES
		// DEL USUARIO, MIENTRAS SE DA ESTE PROCESO BORRAR LOS NOMBRES DEL ARRAY
		// TRIPULACION Y BORRAR LOS ROLES DEL ARRAY ROLES, A LA VEZ QUE SE CREA EL
		// TRIPULANTE
