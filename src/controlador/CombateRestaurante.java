...
/**
 * Controlador del sistema de combate. Específicamente los combates que se dan
 * dentro de MinijuegoRestaurante. La única diferencia con GestorCombate es que
 * no comprueba ni hace uso de los cañones dentro del inventario del Barco a lo
 * largo del combate.
 * 
...
public class CombateRestaurante implements Minijuego {
	...
	/**
	 * Constructor de la clase CombateRestaurante.
	 * 
	...
	/**
	 * Genera un encuentro predeterminado para cuando el combate se da en el
	 * MinijuegoRestaurante.
	 * 
